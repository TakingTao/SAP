class ZCL_ZTJ_FLIGHT_ALP_750_MPC definition
  public
...
TT_SPFLI type standard table of TS_SPFLI .
  ...
  types:
TT_HSCARR type standard table of TS_HSCARR .

  constants GC_HSCARR type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'HScarr' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZTJ_FLIGHT_ALP_750_MPC====CP' ##NO_TEXT.

  methods DEFINE_SPFLI
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_HSCARR
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZTJ_FLIGHT_ALP_750_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZTJ_FLIGHT_ALP_750_SRV' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'HScarr' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZTJ_FLIGHT_ALP_750_MPC=>TS_HSCARR' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'HScarrSet' ). "#EC NOTEXT
...
lo_property = lo_entity_type->create_property( iv_property_name = 'GeneratedId' iv_abap_fieldname = 'GENERATED_ID' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZTJ_FLIGHT_ALP_750_MPC=>TS_SPFLI' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20240104073109'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'Spfli'.                            "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Carrid'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'HScarr'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
ls_text_element-text_symbol            = '004'.              "#EC NOTEXT
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Carrname'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'HScarr'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
